        ...
        {navItems.map((item) => {
          ...
          return (
            ...
            >
              ...
              {active && (
                <div className="absolute top-0 left-1/2 transform -translate-x-1/2 w-12 h-1 bg-gradient-to-r from-pink-400 to-rose-500 rounded-full shadow-lg shadow-pink-200" />
              )}
